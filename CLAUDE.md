...
- [ ] 3-1. API クライアント作成
- [ ] 3-2. ユーザー管理画面 (登録・編集)
- [ ] 3-3. タスク管理画面 (一覧・登録・詳細・編集・削除)
- [ ] 3-4. フロント ↔ バックエンド結合動作確認

### Phase 4: AWS インフラ構築 (WIP)
- [ ] 4-1. ECS + ALB でバックエンドデプロイ
- [ ] 4-2. RDS (PostgreSQL) セットアップ
- [ ] 4-3. フロントエンドデプロイ (Amplify or ECS — 未決定)
